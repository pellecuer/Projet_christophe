 ...
 */
final class Version20190708083722 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tjm ADD CONSTRAINT FK_A88756166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE tjm ADD CONSTRAINT FK_A88756419C3385 FOREIGN KEY (pole_id) REFERENCES pole (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE NONCLUSTERED INDEX IDX_A88756166D1F9C ON tjm (project_id)');
        $this->addSql('CREATE NONCLUSTERED INDEX IDX_A88756419C3385 ON tjm (pole_id)');
    }
}
